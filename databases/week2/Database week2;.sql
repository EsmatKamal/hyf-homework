...
USE week2;
INSERT INTO task (id, title, description, created, updated, due_date, status_id, user_id) VALUES (36, 'Wash shoes', 'Title says it no.', '2023-10-25 06:54:16', '2017-10-15 13:05:09', null, 2, 1);
...
USE week2;
DELETE FROM task WHERE task.id = 8;
